...
type ServiceInterfaceClient interface {
	...
	InsertIndex(ctx context.Context, in *BroadcastIndex, opts ...grpc.CallOption) (*BroadcastResponse, error)
}
...
func (c *serviceInterfaceClient) InsertIndex(ctx context.Context, in *BroadcastIndex, opts ...grpc.CallOption) (*BroadcastResponse, error) {
	out := new(BroadcastResponse)
	err := c.cc.Invoke(ctx, "/service.ServiceInterface/InsertIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceInterfaceServer interface {
	...
	InsertIndex(context.Context, *BroadcastIndex) (*BroadcastResponse, error)
...
func (UnimplementedServiceInterfaceServer) InsertIndex(context.Context, *BroadcastIndex) (*BroadcastResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InsertIndex not implemented")
}
...
func _ServiceInterface_InsertIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BroadcastIndex)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceInterfaceServer).InsertIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.ServiceInterface/InsertIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceInterfaceServer).InsertIndex(ctx, req.(*BroadcastIndex))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceInterface_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InsertIndex",
			Handler:    _ServiceInterface_InsertIndex_Handler,
		},
	},
